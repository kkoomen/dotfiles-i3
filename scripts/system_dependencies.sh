...
sudo apt-get install curl wget vim network-manager network-manager-openvpn-gnome \
  ...
  rofi feh arandr qbittorrent filezilla tree weechat scrot xclip p7zip-full
